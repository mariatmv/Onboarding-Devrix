					...
					<div class="mo_api_authentication_settings_table">
						...
						<div class="mo_api_authentication_common_div_css">
							...
							<div class="mo_auth_method">
								<label>
								  <input type="radio" name="mo_api_authentication_selected_authentication_method" value="tokenapi" onclick="divVisibility('',0,<?php echo $mo_api_disable; ?>)" <?php if( $authentication_method == 'tokenapi' ) { echo 'checked="checked"'; } ?> >
								  <img src="<?php echo plugin_dir_url(dirname(dirname(__FILE__)));?>/images/apikey.png"><br/>API Key
								</label>
							</div>
							<div class="mo_auth_method">
								<label>
								  <input type="radio" name="mo_api_authentication_selected_authentication_method" value="basic_auth" onclick="divVisibility('ShowBasicAuthDiv',<?php echo $mo_api_disable; ?>)" <?php if( $authentication_method == 'basic_auth' ) { echo 'checked="checked"'; } ?> >
								  <img src="<?php echo plugin_dir_url(dirname(dirname(__FILE__)));?>/images/basic-auth.png"><br/>Basic Authentication
								</label>
							</div>
							<div class="mo_auth_method">
								<label>
								  <input type="radio" name="mo_api_authentication_selected_authentication_method" value="jwt_auth" onclick="divVisibility('ShowJwtDiv',<?php echo $mo_api_disable; ?>)" <?php if( $authentication_method == 'jwt_auth' ) { echo 'checked="checked"'; } ?>>
								  <img src="<?php echo plugin_dir_url(dirname(dirname(__FILE__)));?>/images/jwt.png"><br/>JWT Authentication
								</label>
							</div>
							<div class="mo_auth_method">
								<label>
								  <input type="radio" name="mo_api_authentication_selected_authentication_method" value="OAuth 2.0" onclick="divVisibility('ShowOauthDiv',1,<?php echo $mo_api_disable; ?>)" <?php if( $authentication_method == 'oauth_client' ) { echo 'checked="checked"'; } ?> >
								  <img src="<?php echo plugin_dir_url(dirname(dirname(__FILE__)));?>/images/oauth.png"><br/>OAuth 2.0<br><a href="admin.php?page=mo_api_authentication_settings&tab=licensing" target="_blank" rel="noopener noreferrer" style="font-size: x-small">[UPGRADE]</a>
								</label>
							</div>
							<div class="mo_auth_method">
								<label>
								  <input type="radio" name="mo_api_authentication_selected_authentication_method" value="Third Party Provider" onclick="divVisibility('ShowThirdParyProviderDiv',1,<?php echo $mo_api_disable; ?>)" <?php if( $authentication_method == 'thirdpartyprovider' ) { echo 'checked="checked";'; } ?>>
								  <img src="<?php echo plugin_dir_url(dirname(dirname(__FILE__)));?>/images/thirdparty.png"><br/>Third Party Provider <a href="admin.php?page=mo_api_authentication_settings&tab=licensing" target="_blank" rel="noopener noreferrer" style="font-size: x-small">[UPGRADE]</a>
								</label>
							</div>
