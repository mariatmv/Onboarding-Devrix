		...
		<div id="mo_api_authentication_support_layout" class="mo_api_authentication_support_layout">
			<div>
				...
				<h3 style="color: #8a8978">
					We provide the solution for integrating External/Custom API in Wordpress, it will provide the functionality to perform some task or fetch/update the data through the External API call based on some event like any form submission or any WordPress event. For more information please contact us on <u><a>oauthsupport@xecurify.com</a></u>.
				</h3>
				</div>
			</div>
			<br>
