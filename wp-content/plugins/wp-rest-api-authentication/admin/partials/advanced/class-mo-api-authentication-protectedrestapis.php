        ...
        public static function ProtectedRestAPI_display_route_checkboxes() {
            ...
            foreach ( $all_routes as $route ) {
                ...
                if ( $is_route_namespace || "/" == $route ) {
                    ...
                    echo "<h2><label><input name='rest_routes[]' value='" . esc_attr($route) . "' type='checkbox' id='protectedrestapi_namespace_" . esc_attr( $loopCounter ) ."' onclick='protectedrestapi_namespace_click(\"". esc_attr($route) ."\", esc_attr( $loopCounter ) )' " . esc_attr( $checkedProp ) .">&nbsp;".esc_html($route_for_display)."</label></h2><ul>";
                    ...
                    echo "<li><label><input name='rest_routes[]' value='". esc_attr( $route ) ."' type='checkbox' data-namespace='". esc_attr( $current_namespace ) ."' " . esc_attr( $checkedProp ) .">&nbsp;" . esc_html( $route ) . "</label></li>";
                }
