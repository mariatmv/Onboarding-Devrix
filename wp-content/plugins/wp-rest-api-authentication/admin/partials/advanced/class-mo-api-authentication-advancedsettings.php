<?php
	...
	class Mo_API_Authentication_Admin_AdvancedSettings {
		...
		<div class="mo_table_layout">
			    <h3> Custom Header <a href="admin.php?page=mo_api_authentication_settings&tab=licensing" target="_blank" rel="noopener noreferrer" style="font-size: small">[UPGRADE]</a>: </h3>
			...
			<div class="mo_table_layout">
			    <h3> Role based Restriction <a href="admin.php?page=mo_api_authentication_settings&tab=licensing" target="_blank" rel="noopener noreferrer" style="font-size: small">[UPGRADE]</a>: </h3>
			...
			<div class="mo_table_layout">
			    <h3> Token Expiry Configuration <span style="font-size: small"> [Eligible for OAuth 2.0 and JWT Authentication]</span> <a href="admin.php?page=mo_api_authentication_settings&tab=licensing" target="_blank" rel="noopener noreferrer" style="font-size: small">[UPGRADE]</a>: </h3>
			...
			<div class="mo_table_layout">
				<h3> Exclude REST APIs <a href="admin.php?page=mo_api_authentication_settings&tab=licensing" target="_blank" rel="noopener noreferrer" style="font-size: small">[UPGRADE]</a>: </h3>
